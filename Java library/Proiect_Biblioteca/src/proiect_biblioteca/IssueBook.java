...
public class IssueBook extends JFrame implements ActionListener{
	...
	panel.setBorder(new TitledBorder(new LineBorder(new Color(47, 79, 79), 2, true), "Book Details",
	...
	JLabel l10 = new JLabel("Father's Initial");
