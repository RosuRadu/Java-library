...
public class AddStudent extends JFrame implements ActionListener{
	...
	JLabel l3 = new JLabel("Father's Initial");
	...
	comboBox.setModel(new DefaultComboBoxModel(new String[] { "Sciences", "Electrical Engineering", "Mechanics", "Automation, Computers and Electronics", "Law", "Economics and Business Administration", "Other" }));
	...
	comboBox_3.setModel(new DefaultComboBoxModel(
			new String[] { "Physics", "Mathematics", "IT", "Biology", "Chemistry", "Geography", "Other" }));
