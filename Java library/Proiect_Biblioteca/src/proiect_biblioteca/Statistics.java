...
public class Statistics extends JFrame{
	...
	panel.setBorder(new TitledBorder(new LineBorder(new Color(47, 79, 79), 2, true), "Issued Books Details",
	...
	ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("proiect_biblioteca/icons/tenth.png"));
	...
	panel_1.setBorder(new TitledBorder(new LineBorder(new Color(0, 204, 153), 2, true), "Returned Books Details",
